...
sampleClade <- c("MSK","MSK","MSK","MSK","MSK","MTH","MTH","MTH")
...
```{r}
sampleTable_MK <- sampleTable[which(sampleTable$clade=="MSK"),]
...
sampleTable_MK_LA <- sampleTable[which(sampleTable$clade=="MSK"&(sampleTable$part=="leaf"|sampleTable$part=="aril")),]
...
```{r}
#extract subset from sampleTable
sampleTable_MK_RA <- sampleTable[which(sampleTable$clade=="MSK"&(sampleTable$part=="root"|sampleTable$part=="aril")),]
